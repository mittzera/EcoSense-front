...
const Card = ({ content, backg, title, link }) => (
  <div className="w-[80vh] p-2 m-5 mb-10  bg-black bg-opacity-60 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
